...
const Search = () => {
  ...
  const handleFacilityTypeChange = (
    ...
    setSelectedFacilityTypes((prevHotelFacility) =>
      event.target.checked
        ? [...prevHotelFacility, hotelFacility]
        : prevHotelFacility.filter((facility) => facility !== hotelFacility)
    );
  };
  return (
      ...
      <div className="flex flex-col gap-5">
        <div className="flex justify-between items-center">
          ...
          <select
            ...
            className="p-2 border-2 border-blue-600 bg-white rounded-md"
          >
